...
function InsertionCell({ block, bi, road, labelSide, isLast, isFirstBlock, isLastBlock, maintenanceMap, insertionLog, onInsertionTick, onInsertionTimeUpdate, onSweepUpdate, tidInput, onTidChange, onTidKeyDown, onTidFocus, tidInputRef, hideElapsedTid, getTidScheduledTime, getTidAssistRemarkStyle, stablingEditable = false, onEditableTrainIdChange }) {
  ...
  const insTidInputStyle = {
    border: specialTidRemarkStyle ? `1px solid ${specialTidRemarkStyle.border}` : hasTidRemark ? "1px solid #9a7416" : "1px solid #294b65",
    backgroundColor: specialTidRemarkStyle ? specialTidRemarkStyle.bg : hasTidRemark ? "#1c1a0c" : "#091b2d",
    color: specialTidRemarkStyle ? specialTidRemarkStyle.color : hasTidRemark ? "#fde68a" : "#d4e2ee",
    boxShadow: "none",
  };
  ...
  if (expired) {
    return (
      <td className="p-1.5 align-middle" title="Elapsed TID hidden manually" style={{ backgroundColor: INSERTION_PANEL_COLORS.grid, borderLeft: `1px solid ${INSERTION_PANEL_COLORS.gridLine}`, borderRight: labelSide === "left" && isLastBlock ? `1px solid ${INSERTION_PANEL_COLORS.gridLine}` : undefined, borderBottom: insRowLine, borderBottomRightRadius: isWestBottomRightCorner ? 12 : undefined, borderBottomLeftRadius: isEastBottomLeftCorner ? 12 : undefined }}>
        <div className="flex flex-col items-center justify-center gap-1 rounded-xl select-none" style={{ minHeight: 96, padding: "8px 6px", background: insCardBg, border: insCardBorder, opacity: 0.55 }}>
  ...
  return (
    <td className="p-1.5 align-middle" style={{ backgroundColor: INSERTION_PANEL_COLORS.grid, borderLeft: `1px solid ${INSERTION_PANEL_COLORS.gridLine}`, borderRight: labelSide === "left" && isLastBlock ? `1px solid ${INSERTION_PANEL_COLORS.gridLine}` : undefined, borderBottom: insRowLine, borderBottomRightRadius: isWestBottomRightCorner ? 12 : undefined, borderBottomLeftRadius: isEastBottomLeftCorner ? 12 : undefined }}>
      <div className="relative flex flex-col items-center justify-start gap-1.5 rounded-xl" style={{ minHeight: inserted?.isSweeping ? 174 : 96, padding: "8px 6px", background: insCardBg, border: insCardBorder, boxShadow: insCardGlow }}>
        {stablingEditable ? (
          <input
            type="text"
            ...
            className="h-7 w-full rounded-lg border px-1.5 text-center text-[15px] font-black uppercase outline-none placeholder:text-[#47637a]"
            style={{
              borderColor: key ? INSERTION_PANEL_COLORS.cardBorder : INSERTION_PANEL_COLORS.gridLine,
              backgroundColor: key ? "#0a1e31" : INSERTION_PANEL_COLORS.grid,
        ...
        action={
          <div className="flex items-center gap-2">
            <button
              ...
              className="flex items-center gap-2 rounded-xl border px-3.5 py-2 text-[11px] font-semibold transition-colors hover:bg-[#123554] disabled:cursor-not-allowed disabled:opacity-45"
          ...
          {downloadingPng ? "Preparing..." : "Download PNG"}
            ...
            <button
              ...
              className="flex items-center gap-2 rounded-xl border px-3.5 py-2 text-[11px] font-semibold transition-colors hover:bg-[#123554]"
          ...
          {hideFiltered ? "Show 3K1 / SW" : "Hide 3K1 / SW"}
            ...
            <button
              ...
              className="flex items-center gap-2 rounded-xl border px-3.5 py-2 text-[11px] font-semibold transition-colors hover:bg-[#641f2b] disabled:cursor-not-allowed disabled:opacity-45"
                ...
                <tr key={road}>
                  ...
                  {blockIndices.map((bi, i) => {
                    ...
                    if (hideFiltered && isFiltered(block, road, bi)) {
                      return (
                        <td key={bi} className="p-1.5 align-middle" style={{ backgroundColor: INSERTION_PANEL_COLORS.grid, borderLeft: `1px solid ${INSERTION_PANEL_COLORS.gridLine}`, borderRight: labelSide === "left" && isLastBlock ? `1px solid ${INSERTION_PANEL_COLORS.gridLine}` : undefined, borderBottom, borderBottomRightRadius, borderBottomLeftRadius }}>
                          <div className="flex items-center justify-center rounded-xl" style={{ minHeight: 96, border: `1px dashed ${INSERTION_PANEL_COLORS.emptyBorder}`, background: "rgba(7,24,39,0.38)" }}>
