...
function TrainMovementContent() {`,
  ...
  const captureMovementScrollPosition = () => {`,
      ...
      code = replaceRequired(
        code,
        /^\s*if \(movementType === "manual" && !isCompleteMovementTimeInput\(tp1Form\.fromTp1\)\) missing\.push\("Time start moving from TP1 \(HH:MM\)"\);\r?\n/m,
        '',
      ...
      code = replaceRequired(
        ...
        `    const toManual = tp1Form.toManual || "18:35";
    const fromTp1 = subtractThreeMinutesFromHHMM(toManual);`,
